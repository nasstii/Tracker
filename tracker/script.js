...
function updateSelectedDaysCount() {
  ...
  if (selectedDates.length > 5 & selectedDates.length < 15) {
    ...
    document.getElementById('image100').src = './assets/vorona 1.png';
